...
class Otherincome extends Component {
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'openbill/fetchincomeTypeNum', // 订单号
    });
    dispatch({
      type: 'openbill/incomeType', // 列表
    });
    dispatch({
  ...
  save = () => {
    ...
    const payload = {
      ...
      icon_id: this.state.inCome, // 其他收入项目ID
    };
    this.props.dispatch({
      type: 'openbill/otherIncomeSave',
      payload,
      callback: res => {
        if (res.errcode) {
  ...
  updatehandleOk = () => {
    this.props.dispatch({
      type: 'openbill/updateIncomeType',
      payload: {
        ...
        <Card className={commonStyle.rowBackground}>
          ...
          <Row gutter={4} style={{ marginTop: '15px' }}>
            <Col xs={24} sm={24} md={24} lg={24} xl={24}>
              <span style={{ lineHeight: '32px' }}>收入项目: </span>
              <Radio.Group
          ...
          <Row>
            <Col xs={24} sm={24} md={24} lg={12} xl={12}>
              <Card
                ...
                // cover={<Icon type="user" theme="outlined" style={{fontSize:'50px'}} />}
              >
                <Meta
            ...
            <Col xs={24} sm={24} md={24} lg={12} xl={12}>
              <Card
                ...
                // cover={<Icon type="user" theme="outlined" />}
              >
                <Meta
                  avatar={<Icon type="user" theme="outlined" style={{ fontSize: '20px' }} />}
                  title="供应商"
