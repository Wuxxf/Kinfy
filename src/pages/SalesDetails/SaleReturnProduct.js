...
@Form.create()
class SaleReturnProduct extends Component {
  state = {
    saleProduct: [], // 销售货品
    rangeTime: [
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'openbill/fetchReturnProduct', // 获取退货货品
      payload: {
        // operator_id: '',
        // order_id: '',
        // start: '',
  ...
  queryData = fields => {
    ...
    this.props.dispatch({
      type: 'openbill/fetchReturnProduct', // 获取销售单据
      payload:fields,
    });
  };
...
export default SaleReturnProduct