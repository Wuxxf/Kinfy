...
const Conditional = Form.create()(props => {
  const { form, queryData, rangeTime ,queryReset} = props;
...
class Receipt extends Component {
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'openbill/fetchReceipt', // 获取销售单据
      payload: {
      ...
      <div>
        <Card className={commonStyle.rowBackground}>
          <Row gutter={24} type="flex" justify="start">
            ...
            <Col span={4}>
              <Link to="/openbill/salesreceipts">
        ...
        <ReceiptUpdate visible={this.state.updateVisible} {...updateSalesMethods} />
      </div>
    );
  }
}
