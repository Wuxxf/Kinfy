export default {
  ...
  'app.register-result.back-home': '返回登录',// kinfy
  ...
  'menu.home-page':'起始页',
  'menu.reportForm':'报表',
  'menu.reportForm.salesStatistics':'销售统计',
  'menu.reportForm.purchaseStatistics':'采购统计',
  'menu.reportForm.profitStatistics':'利润统计',
  'menu.reportForm.expenditureAnalysis':'支出分析',
  'menu.reportForm.incomeAnalysis':'收入分析',
  'menu.reportForm.singleSalesRanking':'单品销售统计',
  'menu.reportForm.lossStatistics':'货品报损统计',
  'menu.storeManagement':'门店管理',
  'menu.storeManagement.bulletinManagement':'公告管理',
  'menu.storeManagement.storeInformation':'门店信息',
  'menu.storeManagement.employeeManagement':'员工管理',
  'menu.setting':'基础设置',
  'menu.setting.permissionSetting':'权限管理',
  'menu.supplierManagement':'供应商管理',
  'menu.supplierManagement.supplierManagement':'供应商管理',
  'menu.customerManagement':'客户管理',
  'menu.customerManagement.customerManagement':'客户管理',
  'menu.customerManagement.labelSetting':'标签设置',
  'menu.productManagement':'货品管理',
  'menu.productManagement.productList':'货品列表',
  'menu.productManagement.productCategory':'货品类别',
  'menu.productManagement.productUnit':'货品单位',
  'menu.productManagement.causeOfLoss':'报损原因',
  'menu.productManagement.reportLoss':'报损查询',
  'menu.productManagement.productCheck':'货品盘点',
  'menu.productManagement.productCheckList':'盘点记录',
  'menu.balanceOfPayments':'收支明细',
  'menu.balanceOfPayments.revenueManagement':'收入单据',
  'menu.balanceOfPayments.expenditureManagement':'支出单据',
  'menu.purchaseDetail':'采购明细',
  'menu.purchaseDetail.shippingOrder':'进货单据',
  'menu.purchaseDetail.purchaseProduct':'进货货品',
  'menu.purchaseDetail.purchaseReturnForm':'退货单据',
  'menu.purchaseDetail.purchaseReturnProduct':'退货货品',
  'menu.purchaseDetail.paymentForm':'付款单据',
  'menu.salesDetails':'销售明细',
  'menu.salesDetails.salesSlip':'销售单据',
  'menu.salesDetails.saleProduct':'销售货品',
  'menu.salesDetails.returnForm':'退货单据',
  'menu.salesDetails.saleReturnProduct':'退货货品',
  'menu.salesDetails.receipt':'收款单据',
  'menu.openbill':'开单',
  'menu.openbill.sellinggoods':'销售出货',
  'menu.openbill.salesreturn':'销售退货',
  'menu.openbill.salesreceipts':'销售收款',
  'menu.openbill.purchasepurchase':'采购进货',
  'menu.openbill.purchasereturn':'采购退货',
  'menu.openbill.purchasepayment':'采购付款',
  'menu.openbill.otherincome':'其他收入',
  'menu.openbill.otherexpenditure':'其他支出',
};
